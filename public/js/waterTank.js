...
let tank = $('.wrapperReservatorio').analogTank(options);

$(".wrapperReservatorio").resizable({
...
function shrink() {
	document.getElementsByClassName('wrapperReservatorio')[0].setAttribute("style", "width:200px;height:200px;");
	tank.redraw();
}
function enlarge() {
	document.getElementsByClassName('wrapperReservatorio')[0].setAttribute("style", "width:400px;height:400px;");
	tank.redraw();
}
function high() {
...
function setLevel(level){
	tank.updateHeight(level);
	if(tank.fillUnit == "%"){
		tank.setDecimal(0);
		tank.fillValue = (document.getElementById("nivel").value/document.getElementById("capacidade").value)*100
		tank.fillUnit = "%"
    tank.changeRateValue = document.getElementById("nivel").value
    

	}else{
		tank.setDecimal(2);
		tank.fillValue = document.getElementById("nivel").value
		tank.fillUnit = "L"
	}
}
