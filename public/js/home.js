...
function waterTankShow(){
	if(document.getElementById("botaoWaterTankShow").innerHTML == "Reduzir Gráfico"){
		...
		document.getElementById("botaoWaterTankShow").innerHTML = "Expandir Gráfico"
	}else{
		...
		document.getElementById("botaoWaterTankShow").innerHTML = "Reduzir Gráfico"
	}
}

function alterarTempo(opcao){

	document.getElementById("tituloGrafico").innerHTML = "Gráfico - Nível x " + opcao
